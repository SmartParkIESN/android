    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateParkingBtt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Parking parking = new Parking(editTitle.getText().toString(), editStreet.getText().toString(), editStreetNumber.getText().toString(), "none",  editDescription.getText().toString(), place, user);
